...
export const PLANS = {
    ...
    pro: {
        ...
        includedFeatures: [
            ...
            { category: "Intelligence", items: ["150,000 Monthly Intel Pings", "Bot & Ghost Filtering", "UTM Campaign Intelligence"] },
            { category: "Advanced", items: ["Destination Heartbeat (Uptime)", "Retargeting Pixels", "1-Year Data Retention"] }
        ]
    },
    business: {
        name: "Scale",
        ...
        includedFeatures: [
            ...
            { category: "Volume", items: ["2,000,000 Monthly Intel Pings", "Advanced Geo-Heatmaps", "99.99% Uptime SLA"] },
