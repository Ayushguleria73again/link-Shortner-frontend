...
export const PLANS = {
    free: {
        ...
        color: "zinc",
        includedFeatures: [
            { category: "Core", items: ["50 Active Signal Registry", "Standard Support", "Discord Community Access"] },
    ...
    starter: {
        ...
        color: "emerald",
        includedFeatures: [
            { category: "Core", items: ["500 Active Signal Registry", "1 Custom Branded Domain", "CSV Data Export"] },
    ...
    business: {
        ...
        color: "amber",
        includedFeatures: [
            { category: "Core", items: ["50,000 Active Signal Registry", "25 Custom Branded Domains", "SSO/SAML Integration"] },
