...
import HeroSignalRain from '@/components/landing/HeroSignalRain';
            ...
            <section className="relative pt-40 pb-20 px-6 overflow-hidden">
                ...
                <div className="max-w-7xl mx-auto relative z-10 text-center">
                    ...
                    <h1 className="text-6xl md:text-8xl font-black text-black tracking-tight mb-8">
                        COMPANY <span className="bg-gradient-to-r from-indigo-600 to-emerald-500 bg-clip-text text-transparent font-mono">NEWS.</span>
                    </h1>
                    <p className="text-zinc-500 text-lg md:text-xl font-medium max-w-2xl mx-auto mb-16 leading-relaxed">
                        Mastering the future of link management and marketing data.
                    </p>
            ...
            <section className="max-w-7xl mx-auto py-24 px-6">
                {loading ? (
                    <div className="flex flex-col items-center justify-center py-20 gap-4">
                        ...
                        <p className="text-[10px] font-black uppercase tracking-widest text-zinc-300">Loading Feed...</p>
                    </div>
                    ...
                    <div className="text-center py-20 border border-dashed border-zinc-100 rounded-[40px] bg-zinc-50/30">
                        ...
                        <h3 className="text-lg font-black text-zinc-900 mb-2">No results.</h3>
                        <p className="text-sm text-zinc-500 font-medium">No articles match your search criteria.</p>
                    </div>
                )}
            </section>
        </main>
