...
export default function PasswordGateClient({ shortCode }) {
      ...
      <div className="max-w-md w-full animate-in fade-in slide-in-from-bottom-8 duration-700">
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <button 
            type="submit"
            disabled={loading}
            className="w-full bg-black text-white py-6 rounded-[24px] font-black text-xs uppercase tracking-[0.2em] flex items-center justify-center gap-3 hover:bg-zinc-800 transition-all group active:scale-[0.98] disabled:opacity-50"
          >
            {loading ? (
