...
import { Send, AlertCircle, CheckCircle2, X, UploadCloud } from 'lucide-react';
    ...
    if (submitted) {
        return (
            <div className="bg-black min-h-screen flex items-center justify-center p-6">
                ...
                >
                    <div className="w-24 h-24 bg-indigo-500/20 rounded-full flex items-center justify-center mx-auto ring-8 ring-indigo-500/5">
