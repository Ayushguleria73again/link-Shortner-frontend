...
import { FeatureCard, UseCaseCard, FAQItem } from '@/components/landing/LandingFeatures';
      ...
      <section className="relative pt-40 pb-32 px-6 overflow-hidden z-10">
        ...
        <div className="max-w-7xl mx-auto relative z-10">
          ...
          >
            ...
            <motion.h1 
              variants={itemVariants}
              className="text-7xl md:text-[10rem] font-black tracking-tight leading-[0.85] text-black mb-12"
            >
              LESS LINK.<br />
